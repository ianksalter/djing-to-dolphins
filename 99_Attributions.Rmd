...
Some of the images in this work have built upon the work of others. The sources and creators of these images are given below by chapter. Images created by the author are also listed. The latter without exception are licensed under a [Creative Commons Attribution-ShareAlike 4.0 International License](http://creativecommons.org/licenses/by-sa/4.0/).

![](https://i.creativecommons.org/l/by-sa/4.0/88x31.png)

Please note however that, beyond fair use, the text of the work is only licensed under a [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License](http://creativecommons.org/licenses/by-nc-sa/4.0/).

![](https://i.creativecommons.org/l/by-nc-sa/4.0/88x31.png)

The source for this work is available on GitHub at [https://github.com/ianksalter/DJing_to_Dolphins](https://github.com/ianksalter/djing-to-dolphins).
...
* **Contrasting Sounds** Original image by Wassily Kandinsky and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Science and Certainty

* **The Attributes of the Sciences** Original image by Jean-Baptiste-Simeon Chardin and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Mayday

* **The Wreck** Original image by Henri-Edmond Cross and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Brexit and Arrival

* **The Homecoming** Original image by Ferdinand Georg Walsmüller and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Pottering In Porto

* **Airplane Over Train** Original image by Natalia Goncharova and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Giving Up Smoking with Netflix and an Anarchist Philosopher

* **Portrait of a Philosopher** Original image by Lyubov Popova and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Giving Up Smoking Constructively

* **Return to Reason** Original image by Man Ray and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Bragança

* **Fires in the Forest** Original image by Laszlo Mednyanszky and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Porto Again – L’Image 

* **The Ham** Original image by Paul Gaugin and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Porto to Figueira Da Foz 

* **No Areinho, Douro** Original image by António de Carvalho da Silva Porto and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Figueira da Foz to Peniche, A Mathematics of Consent 

* **No Areinho, Douro** Original image by António de Carvalho da Silva Porto and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.
* **Hypatia's Preferences**  Created by the author.
* **Alan's Preferences**  Created by the author.
* **Hypatia's And Alan's Preferences**  Created by the author.

Off Lands End 

* **Longship Lighthouse, Lands End** Original image by J.M.W. Turner and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Peniche to Oeiras 

* **Sailing in the Mist** Original image by John Henry Twachtman and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Bat 

* **Brucie cleaning herself in the box**  Created by the author.

Oeiras to Lisbon

* **Lisbon, Sunrise** Original image by Ivan Aivazovsky and sourced from [Wikiart](https://www.wikiart.org/) as a Public Domain image.

Epilog

* **Last Night I Dreamed I Was Sleeping** Original image by Debbie Atkinson who holds the copyright and has given permission for its use.
